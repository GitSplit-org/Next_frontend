              ...
              {!session ? (
                <li>
                  <Link href="/api/auth/signin/github">
                    <button
                      type="button"
                      class="text-white h-full font-bold rounded-xl bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                      Login with github
                    </button>
                  </Link>
                ...
                <li>
                  <Link href="/api/auth/signout/github">
                    <button
                      type="button"
                      class="text-white h-full font-bold rounded-xl bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                      Signout from github
                    </button>
                  </Link>
